...
_POLICY_TRADEPOLICY_TREND = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='last_sequential_growth_percent', full_name='Policy.TradePolicy.Trend.last_sequential_growth_percent', index=2,
