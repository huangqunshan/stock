...
_POLICY_TRADEPOLICY_TREND = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='half_trend_percent', full_name='Policy.TradePolicy.Trend.half_trend_percent', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='last_sequential_trend_count', full_name='Policy.TradePolicy.Trend.last_sequential_trend_count', index=2,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='trend_mode', full_name='Policy.TradePolicy.Trend.trend_mode', index=4,
