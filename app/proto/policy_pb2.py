...
_POLICY_TRADEPOLICY_TREND = _descriptor.EnumDescriptor(
  name='Trend',
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUDDEN_GRATE_GROWP_UP', index=4, number=5,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SUDDEN_GRATE_FAIL_DOWN', index=5, number=6,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_POLICY_TRADEPOLICY_TREND)
...
_POLICY_TRADEPOLICY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='at_percent', full_name='Policy.TradePolicy.at_percent', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='at_trend', full_name='Policy.TradePolicy.at_trend', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='buy_at_every_days', full_name='Policy.TradePolicy.buy_at_every_days', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sell_at_loss_percent', full_name='Policy.TradePolicy.sell_at_loss_percent', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sell_at_profit_percent', full_name='Policy.TradePolicy.sell_at_profit_percent', index=5,
...
_POLICY_TRADEPOLICY.fields_by_name['at_trend'].enum_type = _POLICY_TRADEPOLICY_TREND
