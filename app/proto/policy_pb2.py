...
_POLICY_TRADEPOLICY_TREND = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='growth_percent', full_name='Policy.TradePolicy.Trend.growth_percent', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='growth_percent_last_half_period', full_name='Policy.TradePolicy.Trend.growth_percent_last_half_period', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='growth_percent_last_quarter_period', full_name='Policy.TradePolicy.Trend.growth_percent_last_quarter_period', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='trend_enum', full_name='Policy.TradePolicy.Trend.trend_enum', index=3,
...
_POLICY_TRADEPOLICY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='trend', full_name='Policy.TradePolicy.trend', index=6,
