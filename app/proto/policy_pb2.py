...
_POLICY_TRADEPOLICY_TREND = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='growth_percent_last_half', full_name='Policy.TradePolicy.Trend.growth_percent_last_half', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='growth_percent_last_one_third', full_name='Policy.TradePolicy.Trend.growth_percent_last_one_third', index=2,
